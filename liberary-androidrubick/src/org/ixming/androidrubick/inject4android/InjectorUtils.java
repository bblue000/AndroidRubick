...
import org.ixming.androidrubick.inject4android.core.BaseInjectLoader;
import org.ixming.androidrubick.inject4android.core.InjectLoaderFactory;
...
public class InjectorUtils {
	 ...
	 * 
	 * <p>
	 * 	此时，所有需要注入的对象都是从Activity对象中查找，View都是调用Activity的findViewById
	 * </p>
	 * @param context
	 *            既是被动注入的对象，又提供Context
	 */
	public void inject(Activity context) {
		BaseInjectLoader baseLoader = InjectLoaderFactory.createFrom(context, context, null);
	...
	/**
	 * 该方法针对的是非继承自Activity或者View的其他类型，比如Fragment，ViewHolder
	 * 
	 * @param target
	 *            目标类实例，具体用于加载资源文件
	 * @param contentView
	 ...
	 * 只注入resource
	 */
	public static void injectRes(Object target, Context localContext) {
		new InjectorUtils(InjectConfigure.InjectResConfigure).innerInject(
			target, InjectConfigure.InjectResConfigure, InjectLoaderFactory.createFrom((View) null, localContext, null));
	}
