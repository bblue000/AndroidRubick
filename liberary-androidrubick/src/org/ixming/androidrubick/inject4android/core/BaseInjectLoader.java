...
import org.ixming.androidrubick.inject4android.annotation.OnClick;
...
//		}
	...
	public boolean injectOnClickMethodListener(final Object target, final Method method) {
		OnClick onClickMethodInject = method.getAnnotation(OnClick.class);
	...
	public boolean injectRes(Object target, Field field) {
		ResById resInject = field.getAnnotation(ResById.class);
		// if annotation is not present, return false
		if (null == resInject) {
			return false;
		}
