...
public class InjectConfigure {
	 ...
	 * 注入View和Click监听器的配置
	 */
	public static final InjectConfigure InjectViewAndOnClickMethodsConfigure;
	static {
		...
		InjectViewAndResConfigure = new SpecInjectConfigure()
			.setToAllInternal(false).injectViewsInternal(true).injectResesInternal(true);
		
		
		InjectViewAndOnClickMethodsConfigure = new SpecInjectConfigure()
			.setToAllInternal(false).injectViewsInternal(true).injectOnClickMethodsInternal(true);
	}
