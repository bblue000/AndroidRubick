package org.ixming.androidrubick.db4android;
 ...
 */
public interface SQLiteConditionDefiner<Bean extends BaseSQLiteModel> {

	/**
	 * @param condition never null，调用者自行设置SQL语句的条件
	 * @param t never null，某一个具体对象
	 */
	void config(SQLiteCondition condition, Bean t);
