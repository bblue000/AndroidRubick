...
public abstract class AsyncTask<Params, Progress, Result> {
     ...
     * with {@link java.util.concurrent.ThreadPoolExecutor}; however, see commentary there for warnings
     * on its use.
     *
     ...
     * itself (this) so that the caller can keep a reference to it.
     *
     * <p>This method is typically used with {@link java.util.concurrent.ThreadPoolExecutor} to
     ...
     * <p>This method must be invoked on the UI thread.
     *
     * @param exec The executor to use.  {@link java.util.concurrent.ThreadPoolExecutor} is available as a
