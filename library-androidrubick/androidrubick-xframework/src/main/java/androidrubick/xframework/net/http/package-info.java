 ...
 * <p/>
 *
 * 在框架中，可以创建一个{@link androidrubick.xframework.net.http.request.XHttpRequest XHttpRequest}，
 * 设置请求必要的元素（如请求URL，方法等），
 * 然后调用{@link androidrubick.xframework.net.http.request.XHttpRequest#performRequest XHttpRequest.performRequest}
 * 发送请求。
 *
 * <p/>
 *
 * {@link androidrubick.xframework.net.http.request.XHttpRequest#performRequest XHttpRequest.performRequest}
 * 方法内部调用了
