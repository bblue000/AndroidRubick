 ...
 * <p/>
 *
 * <code>code</code>如果是错误码，则可参见{@link APIStatus}#ERR_*，特征是<0；
 *
...
public class APIStatus {
     ...
     * 获取状态code
     *
     * （如果是错误码，则可参见{@link APIStatus}#ERR_*，特征是<0；
     *
    ...
    public APIStatus(int code, int dc, String msg) {
        this.code = code;
        this.detailCode = dc;
        this.message = msg;
    }

    public APIStatus code(int code) {
        this.code = code;
        return this;
    }

    public APIStatus detailCode(int code) {
        this.detailCode = code;
        return this;
    }


    public APIStatus message(String msg) {
        this.message = msg;
        return this;
    }
