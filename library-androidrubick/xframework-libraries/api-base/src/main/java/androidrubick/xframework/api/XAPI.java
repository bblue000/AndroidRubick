...
import androidrubick.xframework.impl.api.$APITokenImpl;
...
public class XAPI {
     ...
     * @return 返回API请求处理对象
     */
    public static <Result>APIToken get(String url, Object param, Map<String, String> extraHeaders,
                                         Class<Result> result, APICallback<Result> callback) {
     ...
     * @return 返回API请求处理对象
     */
    public static <Result>APIToken post(String url, Object param, Class<Result> result, APICallback<Result> callback) {
     ...
     * @return 返回API请求处理对象
     */
    public static <Result>APIToken post(String url, Object param, Map<String, String> extraHeaders,
                                          Class<Result> result, APICallback<Result> callback) {
        return doReq(url, HttpMethod.POST, param, extraHeaders, result, callback);
    }

    private static final <Result>APIToken doReq(String url, HttpMethod method,
                                                  Object param, Map<String, String> extraHeaders,
                                                  Class<Result> result, APICallback<Result> callback) {
        APIToken holder = new $APITokenImpl(url, method, param, extraHeaders, result, callback);
        try {
            return holder;
        } finally {
            holder.execute();
