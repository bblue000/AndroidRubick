...
import androidrubick.app.events.internal.XEventAnnotationProcessor;
 ...
 * <p/><p/>
 *
 * · 使用Annotation——{@link androidrubick.app.events.annotation.XEvent}标识
 *
 * 方法，当Annotation——{@link androidrubick.app.events.annotation.XEvent#value()}指定的
 *
...
public class XEventAPI {
    ...
    /**
     * 解析对象所属类方法中的Annotation——{@link androidrubick.app.events.annotation.XEvent}
     */
