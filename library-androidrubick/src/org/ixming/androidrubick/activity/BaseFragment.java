...
public abstract class BaseFragment extends Fragment implements ILocalFragment {
	...
	public void onDetach() {
		FrameworkLog.i("BaseFragment","execute onDetach!!! ");	
		super.onDetach();
	}
	
	@Override
	public void onDestroyView() {
		FrameworkLog.i("BaseFragment","execute onDestroyView!!! ");	
		super.onDestroyView();
	}
	
	@Override
	public void onDestroy() {
		FrameworkLog.i("BaseFragment","execute onDestroy!!! ");	
		super.onDestroy();
	}
	
	@Override
	public void onHiddenChanged(boolean hidden) {
		FrameworkLog.i("BaseFragment","execute onHiddenChanged!!! hidden ? " + hidden);	
		super.onHiddenChanged(hidden);
	}
	
	@Override
	public void onResume() {
		FrameworkLog.d("BaseFragment","execute onResume!!! ");	
		super.onResume();
	}
	
	@Override
	public void onPause() {
		FrameworkLog.d("BaseFragment","execute onPause!!! ");	
		super.onPause();
	}
