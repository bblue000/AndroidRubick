 ...
 * <br/>
 * <p>
 * 1、首先客户端需要有一个ContentProvider类，可以是继承自本框架的{@link org.ixming.androidrubick.db4android.provider.BaseDBProvider}，
 ...
 * 	<tr>
 * 		<td style="width:50%; border:#888 solid 1px;">
 * 			{@link DBManager#queryList(org.ixming.androidrubick.db4android.SQLiteCondition)}
 * 		</td>
 * 		<td style="width:50%; border:#888 solid 1px;">
 * 			根据条件查询，返回记录列表
 * 		</td>
 ...
 * 	<tr>
 * 		<td style="width:50%; border:#888 solid 1px;">
 * 			{@link DBManager#queryOne(org.ixming.androidrubick.db4android.SQLiteCondition)}
 * 		</td>
 * 		<td style="width:50%; border:#888 solid 1px;">
 * 			根据条件查询，返回单条记录
 * 		</td>
 ...
 * 	<tr>
 * 		<td style="width:50%; border:#888 solid 1px;">
 * 			{@link DBManager#updateByClause(android.content.ContentValues, org.ixming.androidrubick.db4android.SQLiteCondition)}
 * 		</td>
 * 		<td style="width:50%; border:#888 solid 1px;">
 ...
 * 	<tr>
 * 		<td style="width:50%; border:#888 solid 1px;">
 * 			{@link DBManager#updateList(java.util.Collection, org.ixming.androidrubick.db4android.UpdateContentValues, org.ixming.androidrubick.db4android.SQLiteConditionDefiner)}
 * 		</td>
 * 		<td style="width:50%; border:#888 solid 1px;">
 ...
 * 	<tr>
 * 		<td style="width:50%; border:#888 solid 1px;">
 * 			{@link DBManager#updateListByPrimaryKey(java.util.Collection, org.ixming.androidrubick.db4android.UpdateContentValues)}
 * 		</td>
 * 		<td style="width:50%; border:#888 solid 1px;">
 ...
 * 	<tr>
 * 		<td style="width:50%; border:#888 solid 1px;">
 * 			{@link DBManager#delete(org.ixming.androidrubick.db4android.SQLiteCondition)}
 * 		</td>
 * 		<td style="width:50%; border:#888 solid 1px;">
 ...
 * 	<tr>
 * 		<td style="width:50%; border:#888 solid 1px;">
 * 			{@link DBManager#deleteList(java.util.Collection, org.ixming.androidrubick.db4android.SQLiteConditionDefiner)}
 * 		</td>
 * 		<td style="width:50%; border:#888 solid 1px;">
 ...
 * @version 1.0
 */
package org.ixming.androidrubick.db4android.dbmanager;
